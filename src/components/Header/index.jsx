    ...
    return (
        ...
        <div className="head__search">
            <form action="" className="head__search-form">
                <button className="head__search-form-btn"><i className="fas fa-search"></i></button>
                <input type="text" className="head__search-form-input"  placeholder="Tìm kiếm khóa học, bài viết, video, ..." />
            </form>
        </div>
        
        <div className="head__navbar-user" ref={notificationRef}>
            <button className="head__navbar-user-bell" onClick={(e)=>showNotification(e)} >
                <i className="fas fa-bell"></i>
                <div className={`head__navbar-user-bell-notification ${isShowNotification ? 'notification__Active' : ''}`}>
                        ...
                        <ul className="head__navbar-user-bell-notification-list">
                        
                            {
                                ...
                                notifications.map( notification => (
                                    <li key={notification.id} className="head__navbar-user-bell-notification-list-item">
                                        ...
                                        <div className="head__navbar-user-bell-notification-list-item__text">
                                            <div className="message">
                                                {notification.fw} <span className="name">{notification.name}</span> {notification.message}
                                            </div>
                                            <div className="head__navbar-user-bell-notification-list-item__text__time">{notification.time} tháng trước</div>
                                        </div>
                                    </li>
                                ))
                            }
            ...
            <button ref={informationRef} className="head__navbar-user-information" onClick={(e)=>showInformation(e)} >
                <img className='head__navbar-user-information-img__avatar' src={userIcon} alt="" />
                <div className={`head__navbar-user-information-box ${isShowInformation ? 'information__Active' : ''}`}>
                    <ul className="menu__user">
                    <div className="menu__user__information">
                        <img src={userIcon} alt="" />
                        <div className="menu__user__information__text">
                            <div className="menu__user__information__text-name">congminh nguyen</div>
                            <div className="menu__user__information__text-email">@congminh-nguyen</div>
                        </div>
                    </div>
                    <hr />
                    <ul className="menu__user__list">
                        <li className="menu__user__list-item"><a className="menu__user__list-item-link" href=" "> Viết Blog</a></li>
                        <li className="menu__user__list-item"><a className="menu__user__list-item-link" href=" ">Bài viết của tôi</a></li>
                    </ul>
                    <hr />
                    <ul className="menu__user__list content-has-save">
                        <li className="menu__user__list-item"><a className="menu__user__list-item-link" href=" ">Nội dung đã lưu</a></li>
                    </ul>
                    <hr />

                        <li id="user__logout"><a id="logout__link" href=""> Đăng Xuất</a></li>
